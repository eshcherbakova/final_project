...
public class part_allurl extends Configured implements Tool {
    ...
    private Job getJobConf(final String input, final String output) throws IOException {
        ...
        job.setJarByClass(part_allurl.class);
        job.setInputFormatClass(TextInputFormat.class);
        job.setJobName(part_allurl.class.getCanonicalName());
        job.setInputFormatClass(TextInputFormat.class);
    ...
    static public void main(final String[] args) throws Exception {
        final int ret = ToolRunner.run(new part_allurl(), args);
        System.exit(ret);
    }
}
